...
<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <div class="table-responsive">
      <table class="table table-bordered agenda" id="agenda_aktif" width="100%" cellspacing="0">
        <thead>
          <tr>
          	<th width="1%">No</th>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="#" id="form-agenda">
            ...
            <div class="form-group">
              <label for="tanggal">Jadwal Mulai</label>
            ...
            <div class="form-group">
              <label for="tanggal">Jadwal Selesai</label>
            ...
            <div class="form-group">
              ...
              <input type="text" id="tempat" name="tempat" class="form-control" placeholder="Lokasi">
            </div>
        </form>     
        </div>
